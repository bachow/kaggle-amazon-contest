...
def greedy_selection(feature_array, results, predictive_model, num_iter = 10, SEED = 42):
    score_hist = []
    good_features = set([])
...
def backwards_selection(feature_array, results, predictive_model, num_iter = 10, SEED = 42):
    score_hist = []
...
def pick_top_auc(feature_array, results, predictive_model, num_iter = 10, SEED = 42, pool = pool):
    scores = []
    args = []
    for f in range(len(feature_array)):
        Xt = feature_array[f]
...
### Given an array of identifiers, produce array of 'rare' events ###
...
def forward_selection_2(feature_array, results, predictive_model, num_iter = 10, pool = pool, SEED = 42):
    score_hist = []
    good_features = set([])
    last_dropped = None
    last_added = None
...
def greedy_selection_cutoff(cutoff_array, results, predictive_model, num_iter = 5, SEED = 42):
    score_hist = []
    good_features = set([])
